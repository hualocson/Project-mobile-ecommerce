...
@AndroidEntryPoint
class OrderPendingFragment : BaseFragment<FragmentAdminOrderPendingBinding>(true) {
...
//        orderViewModel.fetchAllUserOrders()
    ...
    private fun setUpRecycleView() {
        binding.rvcorderpending.adapter = orderAdminAdapter
    ...
    private fun filterList(newText: String) {
        ...
        orderViewModel.orderPendingData.value!!.forEach { item ->

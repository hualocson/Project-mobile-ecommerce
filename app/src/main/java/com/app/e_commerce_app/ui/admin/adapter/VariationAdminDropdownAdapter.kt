...
import com.app.e_commerce_app.databinding.ItemAdminDropdownVariationBinding
...
class VariationAdminDropdownAdapter(
    private val context: Context,
) : RecyclerView.Adapter<VariationAdminDropdownAdapter.VariationAdminViewHolder>(),
    ...
    inner class VariationAdminViewHolder(
        private val binding: ItemAdminDropdownVariationBinding,
    ) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VariationAdminViewHolder {
        val binding =
            ItemAdminDropdownVariationBinding.inflate(LayoutInflater.from(context), parent, false)
